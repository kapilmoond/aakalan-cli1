...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Aakalan Agent session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Aakalan Agent session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Aakalan Agent agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Aakalan Agent Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Aakalan Agent gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Aakalan Agent session in it",
