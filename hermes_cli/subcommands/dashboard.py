...
def _add_server_runtime_args(parser) -> None:
    ...
    parser.add_argument(
        "--stop",
        action="store_true",
        help="Stop all running Aakalan Agent web server processes and exit",
    )
    parser.add_argument(
        "--status",
        action="store_true",
        help="List running Aakalan Agent web server processes and exit",
    )
...
def build_dashboard_parser(
    ...
    dashboard_parser = subparsers.add_parser(
        ...
        description="Launch the Aakalan Agent Agent web dashboard for managing config, API keys, and sessions",
    )
    ...
    # showed "Aakalan Agent couldn't start" with no actionable cause. Accept and silently
    ...
    serve_parser = subparsers.add_parser(
        "serve",
        help="Start the Aakalan Agent backend server (headless; powers the desktop app and remote backends)",
        description=(
            "Run the Aakalan Agent backend server — the JSON-RPC/WebSocket gateway the "
