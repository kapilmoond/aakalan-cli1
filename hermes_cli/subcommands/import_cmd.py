...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import",
        help="Restore a Aakalan Agent backup from a zip file",
        description="Extract a previously created Aakalan Agent backup into your "
        "Aakalan Agent home directory, restoring configuration, skills, "
        "sessions, and data",
    )
