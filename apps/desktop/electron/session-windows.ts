...
// (the "Aakalan Agent idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Aakalan Agent" wake word has NO preceding click,
