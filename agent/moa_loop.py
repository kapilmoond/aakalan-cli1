...
MoA-enabled; the normal Aakalan Agent agent loop still owns tool calling and turn
...
def _reference_messages(messages: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    conversation flow, but flatten it into clean user/assistant *text* turns:
      ...
      - system prompt: dropped (8K of Aakalan Agent boilerplate, not advisory signal).
...
def aggregate_moa_context(
    *,
    ...
    synth_prompt = (
        ...
        "Aakalan Agent agent. Focus on next steps, tool-use strategy, risks, and any "
    ...
    return (
        ...
        "normal Aakalan Agent agent loop. You may call tools, continue reasoning, or "
        "finish normally.]\n"
