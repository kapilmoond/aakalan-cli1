...
export function formatBlockerMessage(result: VenvBlockerScanResult): string {
  const lines = [
    'Update aborted: another Aakalan Agent process is using this installation.',
    '',
...
export function formatProbeFailedMessage(): string {
  return (
    'Update aborted: Desktop could not verify the Aakalan Agent installation is free.\n' +
    '\n' +
    'Close other Aakalan Agent windows and terminals, then retry.  If the problem\n' +
