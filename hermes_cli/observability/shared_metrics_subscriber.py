"""Relay subscriber for the persisted Aakalan Agent shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Aakalan Agent counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Aakalan Agent shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
