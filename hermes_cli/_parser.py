...
def build_top_level_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="hermes",
        description="Aakalan Agent Agent - AI assistant with tool-calling capabilities",
    ...
    chat_parser = subparsers.add_parser(
        ...
        description="Start an interactive chat session with Aakalan Agent Agent",
    )
    ...
    _inherited_flag(
        ...
        action="store_true",
        default=argparse.SUPPRESS,
        help="Troubleshooting mode: disable ALL customizations — user config, AGENTS.md/memory injection, plugins, and MCP servers (implies --ignore-user-config and --ignore-rules). Use to isolate whether a problem comes from your setup or from Aakalan Agent itself.",
    )
    chat_parser.add_argument(
        "--source",
        default=None,
