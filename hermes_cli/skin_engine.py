...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Aakalan Agent Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Aakalan Agent "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Aakalan Agent Agent"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Aakalan Agent — gold and kawaii",
        ...
        "branding": {
            "agent_name": "Aakalan Agent Agent",
            "welcome": "Welcome to Aakalan Agent Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Aakalan Agent ",
            "prompt_symbol": "❯",
