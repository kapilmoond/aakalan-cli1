...
supported components into records consumed by Aakalan Agent' existing skill and MCP
...
def _translate_remote(config: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    The returned record targets Aakalan Agent' existing URL-based MCP runtime.
