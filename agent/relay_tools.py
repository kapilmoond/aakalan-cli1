"""Core NeMo Relay adapter for Aakalan Agent tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Aakalan Agent tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Aakalan Agent Relay tool execution cannot run on an active event-loop thread"
    )
