...
$InstallStages = @(
    ...
    @{ Name = "repository";       Title = "Cloning Aakalan CLI";                   Category = "install";      NeedsUserInput = $false; Worker = "Stage-Repository" }
...
$InstallStages += @(
    @{ Name = "path";             Title = "Adding Aakalan to PATH";                Category = "finalize";     NeedsUserInput = $false; Worker = "Stage-Path" }
