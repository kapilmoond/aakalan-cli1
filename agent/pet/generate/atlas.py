"""Deterministic spritesheet assembly — generated row strips → Aakalan Agent atlas.
...
def compose_atlas(frames_by_state: dict[str, list]):
    """Pack per-state frame lists into the Aakalan Agent atlas (RGBA, residue-cleared).
