...
def _model_flow_custom(config):
    ...
    if probe.get("used_fallback") and probe.get("resolved_base_url"):
        ...
        print(
            ...
            f"Aakalan Agent will still save it."
        )
...
def _model_flow_azure_foundry(config, current_model=""):
    ...
    * Manual entry when every probe fails (private endpoints, etc.).
    ...
    print("Anthropic-style API endpoints.  Aakalan Agent will probe your")
    ...
    if use_entra:
        ...
        if not has_azure_identity_installed():
            ...
            print(
                "  Aakalan Agent will install it now (the preflight below "
...
def _model_flow_copilot_acp(config, current_model=""):
    ...
    print("  GitHub Copilot ACP delegates Aakalan Agent turns to `copilot --acp`.")
    print("  Aakalan Agent currently starts its own ACP subprocess for each request.")
    print("  Aakalan Agent uses your selected model as a hint for the Copilot ACP session.")
    ...
    if provider_id == "gemini" and existing_key:
        ...
        if probe_gemini_tier is not None:
            ...
            if tier == "free":
                ...
                print(
                    "   Aakalan Agent typically makes 3-10 API calls per user turn "
                ...
                print()
                print(
                    "   To use Gemini with Aakalan Agent, enable billing on your "
