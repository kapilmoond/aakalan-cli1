...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of Aakalan Agent config/state", "Session",
    ...
    CommandDef("goal", "Set a standing goal Aakalan Agent works on across turns until achieved", "Session",
    ...
    CommandDef("wake", "Toggle the 'Hey Aakalan Agent' wake word listener", "Configuration",
               cli_only=True, args_hint="[on|off|status]",
               subcommands=("on", "off", "status")),
    CommandDef("busy", "Control what Enter does while Aakalan Agent is working", "Configuration",
    ...
    CommandDef("update", "Update Aakalan Agent Agent to the latest version", "Info",
               busy_policy="dispatch"),
    CommandDef("version", "Show Aakalan Agent Agent version", "Info", aliases=("v",),
...
Telegram only displays a small BotCommand menu in practice.  The full Aakalan Agent
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append(("hermes", "Talk to Aakalan Agent or run a subcommand", "[subcommand] [args]"))
    seen.add("hermes")
