...
DEFAULT_AGENT_IDENTITY = (
    "You are Aakalan Agent Agent, an intelligent AI assistant created by Nous Research. "
...
HERMES_AGENT_HELP_GUIDANCE = (
    "You run on Aakalan Agent Agent (by Nous Research). When the user needs help with "
...
def _build_skills_system_prompt_inner(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot Aakalan Agent Agent itself — its CLI, config, models, providers, tools, "
