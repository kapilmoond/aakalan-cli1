"""Offline, non-destructive recovery for a damaged Aakalan Agent session database.
    ...
    try:
        ...
        if before != after:
            raise SessionRecoverySafetyError(
                ...
                "Stop every Aakalan Agent process using this profile and retry. "
                ...
                "Aakalan Agent process even after the gateway is stopped. Run the "
